...
export const ToggleSwitch = ({ checked, onChange, className = "", size = 'md' }: ToggleSwitchProps) => {
  ...
  return (
    <button
      onClick={onChange}
      className={`relative inline-flex ${sizeClasses} items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${className}`}
      style={{
