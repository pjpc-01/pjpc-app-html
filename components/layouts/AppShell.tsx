    ...
    navItems: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: "教师考勤与排班", href: "/teacher-attendance-reports", icon: CalendarCheck },
...
export default function AppShell({
  ...
  const CHILD_PERM: Record<string, string> = {
    ...
    "/teacher-performance": "education.performance",
  ...
  const BREADCRUMB_LABELS: Record<string, { label: string; parent?: string }> = {
    ...
    "/teacher-attendance-reports": { label: "教师考勤与排班", parent: "教务" },
    "/course-management": { label: "课程管理", parent: "教务" },
    "/teacher-teaching-report": { label: "教学评估", parent: "教务" },
    "/teacher-performance": { label: "绩效管理", parent: "教务" },
