...
class UnifiedFieldMapper {
  ...
  static Map<String, bool> checkNfcFieldsCompleteness(Map<String, dynamic> data, String collectionType) {
    final requiredFields = ['nfc_tag_id', 'nfc_associated_at'];
    final optionalFields = ['nfc_last_used', 'nfc_usage_count', 'nfc_card_number'];
  ...
  static Map<String, dynamic> getNfcStatusSummary(Map<String, dynamic> data) {
    final hasNfcTag = data.containsKey('nfc_tag_id') && data['nfc_tag_id'] != null && data['nfc_tag_id'].toString().isNotEmpty;
  ...
  static Map<String, String> formatNfcDataForDisplay(Map<String, dynamic> data) {
    ...
    if (data.containsKey('nfc_tag_id') && data['nfc_tag_id'] != null) {
      formatted['NFC标签ID'] = data['nfc_tag_id'].toString();
    }
  ...
  static Map<String, dynamic> validateNfcData(Map<String, dynamic> data) {
    ...
    if (data.containsKey('nfc_tag_id')) {
      final tagId = data['nfc_tag_id'];
      if (tagId == null || tagId.toString().isEmpty) {
        result['errors'].add('NFC标签ID不能为空');
