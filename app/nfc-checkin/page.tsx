    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">NFC 打卡系统</h1>
            <p className="text-gray-600">13.56MHz NFC 读卡器 - 侧入口</p>
          </div>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <div className="text-gray-600">NFC Reader (13.56MHz)</div>
              </div>
              <div>
                <Label className="text-sm font-medium">设备ID</Label>
                <div className="text-gray-600">nfc_reader_001</div>
              </div>
              <div>
                <Label className="text-sm font-medium">位置</Label>
                <div className="text-gray-600">侧入口</div>
              </div>
              <div>
                <Label className="text-sm font-medium">频率</Label>
                <div className="text-gray-600">13.56MHz</div>
              </div>
            </div>
          </CardContent>
        </Card>
