...
import { getPaymentStatusBadge, calculateInvoicePaymentStatus, getPaymentStatusOptions } from "./shared"
...
export function InvoiceList({
  ...
  const getInvoicePaymentStatusBadge = (invoiceId: string) => {
    const invoice = invoices.find(inv => inv.id === invoiceId)
    if (!invoice) {
      return <Badge variant="outline">未知</Badge>
    }
    
    const status = calculateInvoicePaymentStatus(invoice, payments)
              ...
              <TableBody>
                {invoices.map((invoice) => (
                  <TableRow key={invoice.id}>
                    ...
                    <TableCell>
                      {getInvoicePaymentStatusBadge(invoice.id)}
                    </TableCell>
